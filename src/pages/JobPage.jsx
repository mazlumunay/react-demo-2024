...
const JobPage = () => {
  ...
  return loading ? <Spinner /> : job ? <h1>{job.title}</h1> : <p>Job not found</p>;
};
...
const JobPage = ({deleteJob}) => {
  ...
  const onDeleteClick = (jobId) => {
    const confirm = window.confirm('Are you sure you want to delete that listing?')
        ...
        <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          <main>
            ...
            >
              ...
              >
                <FaMapMarker className='text-orange-50700 mr-1'/>
